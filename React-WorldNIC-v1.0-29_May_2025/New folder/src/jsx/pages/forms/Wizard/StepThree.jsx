      ...
      <section>
         <div className="row">
            <div className="col-sm-4 mb-2">
               <label className="col-form-label required">Monday</label>
            </div>
         ...
         <div className="row">
            <div className="col-sm-4 mb-2">
               <label className="col-form-label required">Tuesday</label>
            </div>
            <div className="col-6 col-sm-4 mb-2">
               <div className="mb-3">
         ...
         <div className="row">
            <div className="col-sm-4 mb-2">
               <label className="col-form-label required">Wednesday</label>
            </div>
            <div className="col-6 col-sm-4 mb-2">
               <div className="mb-3">
         ...
         <div className="row">
            <div className="col-sm-4 mb-2">
               <label className="col-form-label required">Thrusday</label>
            </div>
            <div className="col-6 col-sm-4 mb-2">
               <div className="mb-3">
         ...
         <div className="row">
            <div className="col-sm-4 mb-2">
               <label className="col-form-label required">Friday</label>
            </div>
            <div className="col-6 col-sm-4 mb-2">
               <div className="mb-3">
