...
import ActiveUser from "../../components/WidgetBasic/ActiveUser";
import AllSell1 from "../../components/WidgetBasic/AllSell1";
import AllSell2 from "../../components/WidgetBasic/AllSell2";
import BloodPressur from "../../components/WidgetBasic/BloodPressure";
import Clolesterol from "../../components/WidgetBasic/Clolesterol";
import FeeCollection from "../../components/WidgetBasic/FeeCollection";
import GlucoseRate from "../../components/WidgetBasic/GlucoseRate";
import HeartRate from "../../components/WidgetBasic/HeartRate";
import LifeTimeEarning from "../../components/WidgetBasic/LifeTimeEarning";
import MarketNow from "../../components/WidgetBasic/MarketNow";
import NewStudent from "../../components/WidgetBasic/NewStudent";
import PowerBar from "../../components/WidgetBasic/PowerBar";
import PowerLine from "../../components/WidgetBasic/PowerLine";
import SalesAnalysis from "../../components/WidgetBasic/SalesAnalysis";
import TopProducts1 from "../../components/WidgetBasic/TopProducts1";
import TopProducts2 from "../../components/WidgetBasic/TopProducts2";
import TotalCourse from "../../components/WidgetBasic/TotalCourse";
import TotalStudent from "../../components/WidgetBasic/TotalStudent";
import ViewProject from "../../components/WidgetBasic/ViewProject";
import VisitorActivity from "../../components/WidgetBasic/VisitorActivity";
import WeeklySales1 from "../../components/WidgetBasic/WeeklySales1";
import WeeklySales2 from "../../components/WidgetBasic/WeeklySales2";
      ...
      <div className="row">
        <div className="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
          <div className="card text-white bg-primary">
            <ul className="list-group list-group-flush">
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 text-white">Blood type :</span>
                <strong className="text-white">O+</strong>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 text-white">Allergies :</span>
                <strong className="text-white">Penicilin, peanuts </strong>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 text-white">Pressure :</span>
                <strong className="text-white">120/100 mmHG</strong>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 text-white">Diseases :</span>
                <strong className="text-white">Diabetes</strong>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 text-white">Temperture :</span>
                <strong className="text-white">34 Degree</strong>
              </li>
            </ul>
          </div>
        </div>
        <div className="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
          <div className="card text-white text-black">
            <ul className="list-group list-group-flush">
              <li className="list-group-item d-flex justify-content-between">
              ...
              <li className="list-group-item d-flex justify-content-between">
                ...
                <strong className="">Dentist</strong>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 ">Dr Valentino Morose :</span>
                <strong className="">Surgeon</strong>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 ">Dr Fleece Marigold :</span>
                <strong className="">Clinical</strong>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <span className="mb-0 ">Dr Eric Widget :</span>
                <strong className="">Cardiology</strong>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="col-xl-4 col-lg-12 col-xxl-4 col-sm-12">
          <div className="card">
            <div className="card-body text-center ai-icon  text-primary">
              ...
              <Link className="btn my-2 btn-primary px-4">
        ...
        <div className="col-xl-4 col-lg-12 col-sm-12">
          <div className="card overflow-hidden">
            <div
              ...
              style={{ backgroundImage: `url(${IMAGES.big5})` }}
            >
              <img
                src={IMAGES.profile}
                width="100"
              ...
              <div className="widget-media">
                <ul className="timeline">
                  <li>
                    <div className="timeline-panel">
                      <div className="media me-2">
                        <img alt="" width="50" src={IMAGES.avatar4} />
                      </div>
                      <div className="media-body">
                        <h5 className="mb-1">Dr sultads Send you Photo</h5>
                        <small className="d-block">
                  ...
                  <li>
                    <div className="timeline-panel">
                      <div className="media me-2 media-info">
                        <img width="50" alt="" src={IMAGES.avatar2} />
                      </div>
                      <div className="media-body">
                        <h5 className="mb-1">Resport created successfully</h5>
                        <small className="d-block">
                  ...
                  <li>
                    <div className="timeline-panel">
                      <div className="media me-2 media-success">
                        <img width="50" alt="" src={IMAGES.avatar3} />
                      </div>
                      <div className="media-body">
                        <h5 className="mb-1">Reminder : Treatment Time!</h5>
                        <small className="d-block">
