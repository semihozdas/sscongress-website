            ...
            <Card.Body>
              <div className="basic-dropdown">
                <Dropdown>
                  ...
                  <Dropdown.Menu className="dropdown-menu-right z-2">
                    <Dropdown.Item href="#">Link 1</Dropdown.Item>
                    <Dropdown.Item href="#">Link 2</Dropdown.Item>
                    <Dropdown.Item href="#">Link 3</Dropdown.Item>
                  </Dropdown.Menu>
            ...
            <Card.Body>
              <div className="basic-dropdown">
                ...
                <DropdownButton
                  ...
                  drop="start"
                  variant="primary"
                  className="dropstart me-1 mt-1 z-2"
                  title="dropstart"
                >
                  <Dropdown.Item href="#">Link 1</Dropdown.Item>
                  <Dropdown.Item href="#">Link 2</Dropdown.Item>
          ...
          <Card>
            ...
            <Card.Body>
              <Row>
                <Col xl={3}>
                  <Dropdown>
                    <Dropdown.Toggle variant="" className="ps-0 mt-1 mb-2 z-2">
                      Last 7 days
                    </Dropdown.Toggle>
                    <Dropdown.Menu>
