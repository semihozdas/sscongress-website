...
function Content() {
    ...
    return (
        <>
            <PageTitle motherMenu="CMS" activeMenu="Content" />
            <div className="row">
                <div className="col-xl-12">
                    <div className="filter cm-content-box box-primary">
                        <div className="content-title SlideToolHeader">
                            <div className="cpa"> <i className="fa-sharp fa-solid fa-filter me-2" /> Filter </div>
                            <div className="tools">
                    ...
                    <div className="mb-4 pb-3">
                        <Link to={"/content-add"} className="btn btn-primary btn-sm">Add Content</Link>
                    </div>
                    <div className="filter cm-content-box box-primary">
                        <div className={`content-title SlideToolHeader`}>
                            <div className="cpa"> <i className="fa-solid fa-file-lines me-1" /> Contact List </div>
                            <div className="tools">
