...
function AddEmail() {
    ...
    return (
        <>
            <PageTitle motherMenu="CMS" activeMenu="Add Email" />
            <div className="row">
                ...
                <div className="col-xl-12">
                    <div className="filter cm-content-box box-primary">
                        <div className="content-title SlideToolHeader">
                            ...
                            <div className="tools">
                                <Link to={"#"} className={`SlideToolHeader ${collapseBtn ? 'collapse' : 'expand'}`} onClick={() => setCollapseBtn(!collapseBtn)} >
                                ...
                                <div className="card-body">
                                    <div className="row">
                                        ...
                                        <div className="text-end">
                                            <button type="submit" className="btn btn-primary">Save EmailTemplate</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
